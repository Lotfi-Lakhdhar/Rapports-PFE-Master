<?php $titre_layout = 'Mes Tâches'; ?>


<!-- Page Heading/Breadcrumbs -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Mes tâches
        ...
        <?php foreach($posts as $k => $v) : ?>
           ...
           <!-- First Blog Post -->
                <h2>
                    <a href="<?php echo Router::url("posts/view_1/id:{$v-> id}/slug:{$v-> slug}") ?>"><?=  $v-> name; ?></a>
                </h2>
                ...
                <p><?= $v -> content; ?></p>
                <a class="btn btn-primary" href="<?php echo Router::url("posts/view_1/id:{$v-> id}/slug:{$v-> slug}") ?>">Lire la suite <i class="fa fa-angle-right"></i></a>
