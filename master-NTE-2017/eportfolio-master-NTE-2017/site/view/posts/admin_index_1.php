...
<a class="btn btn-success" href="<?= Router::url('admin/posts/edit_1') ?>"> Ajouter une tâche</a>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>   
            ...
            <td> <?= $v -> name ?> </td>
            <td>
              <a class="btn btn-primary" href="<?= Router::url('admin/posts/edit_1/'.$v->id);?>"> Editer </a>
