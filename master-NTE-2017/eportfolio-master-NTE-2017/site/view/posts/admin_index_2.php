...
<a class="btn btn-success" href="<?= Router::url('admin/posts/edit_2') ?>"> Ajouter un carnet</a>
<table class="table">
    <thead>
        <tr>
            <th> ID </th>
    ...
    <tbody>
        ...
        <tr>   
            ...
            <td> <?= $v -> name ?> </td>
            <td>
              <a class="btn btn-primary" href="<?= Router::url('admin/posts/edit_2/'.$v->id);?>"> Editer </a>
