...
<a class="btn btn-success" href="<?= Router::url('admin/posts/edit_p') ?>"> Ajouter une présentation</a>
<table class="table">
    <thead>
        <tr>
            <th> ID </th>
    ...
    <tbody>
        ...
        <tr>   
            ...
            <td> <?= $v -> name ?> </td>
            <td>
              <a class="btn btn-primary" href="<?= Router::url('admin/posts/edit_p/'.$v->id);?>"> Editer </a>
